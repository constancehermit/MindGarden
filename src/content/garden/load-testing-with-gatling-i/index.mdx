...
<NoteDefinition text="IDE: Integrated Development Environment (e.g. Eclipse, IntelliJ)
...
<NoteDefinition text="SUIT: System Under Intense Test"/>
...
<NoteDefinition text="UI: User Interface
...
Alright, so interacting with a Web App is a bit like ordering at a food place. How does Gatling go about stressing that system?
...
<NoteDefinition text="REST: REpresentational State Transfer (architectural style for web services)"/>
